/* Zepto 1.1.6 - zepto event data ajax detect form ie fx fx_methods selector touch gesture stack - zeptojs.com/license */
var Zepto = function () {
  function D(t) {
  ...
  function _(t) {
    return $(t) && !Z(t) && Object.getPrototypeOf(t) == Object.prototype
  }
  ...
  function B(t, e) {
    return "number" != typeof e || l[q(t)] ? e : e + "px"
  }
  ...
  var t, e, n, i, O, P, r = [], o = r.concat, a = r.filter, s = r.slice, u = window.document, f = {}, c = {}, l = {
    "column-count": 1,
    columns: 1,
    "font-weight": 1,
    "line-height": 1,
    ...
    th: w,
    "*": u.createElement("div")
  }, E = /complete|loaded|interactive/, T = /^[\w-]*$/, S = {}, j = S.toString, C = {}, N = u.createElement("div"), M = {
    tabindex: "tabIndex",
    readonly: "readOnly",
    "for": "htmlFor",
    "class": "className",
  ...
  return C.matches = function (t, e) {
    ...
    return o && (r = N).appendChild(t), i = ~C.qsa(r, e).indexOf(t), o && N.removeChild(t), i
  }, O = function (t) {
    ...
    if ("string" == typeof e)if (e = e.trim(), "<" == e[0] && h.test(e))r = C.fragment(e, RegExp.$1, i), e = null; else {
      ...
      if (C.isZ(e))return e;
      if (A(e))r = F(e); else if ($(e))r = [e], e = null; else if (h.test(e))r = C.fragment(e.trim(), RegExp.$1, i), e = null; else {
        if (i !== t)return n(i).find(e);
        r = C.qsa(u, e)
      }
    }
    ...
    return !1
  }, n.type = D, n.isFunction = k, n.isWindow = Z, n.isArray = A, n.isPlainObject = _, n.isEmptyObject = function (t) {
    var e;
    for (e in t)return !1;
    return !0
    ...
    closest: function (t, e) {
      var i = this[0], r = !1;
      for ("object" == typeof t && (r = n(t)); i && !(r ? r.indexOf(i) >= 0 : C.matches(i, t));)i = i !== e && !L(i) && i.parentNode;
      return n(i)
    },
    parents: function (t) {
    ...
    offset: function (t) {
      if (t)return this.each(function (e) {
        var i = n(this), r = Y(this, t, e, i.offset()), o = i.offsetParent().offset(), a = {
          top: r.top - o.top,
          left: r.left - o.left
        };
      ...
      if (arguments.length < 2) {
        ...
        if (A(t)) {
          ...
          return n.each(t, function (t, e) {
            a[e] = o.style[O(e)] || r.getPropertyValue(e)
          }), a
        }
      }
      var s = "";
      if ("string" == D(t))i || 0 === i ? s = q(t) + ":" + B(t, i) : this.each(function () {
        this.style.removeProperty(q(t))
      }); else for (e in t)t[e] || 0 === t[e] ? s += q(e) + ":" + B(e, t[e]) + ";" : this.each(function () {
    ...
    toggleClass: function (e, i) {
      return e ? this.each(function (r) {
        var o = n(this), a = Y(this, e, r, G(this));
    ...
    n.fn[t] = function () {
      ...
      return r.length < 1 ? this : this.each(function (t, s) {
        ...
        r.forEach(function (t) {
          if (a)t = t.cloneNode(!0); else if (!o)return n(t).remove();
  ...
  }), C.Z.prototype = U.prototype = n.fn, C.uniq = P, C.deserializeValue = K, n.zepto = C, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
  ...
  }, a = {}, s = {}, u = "onfocusin" in window, f = {focus: "focusin", blur: "focusout"}, c = {
  ...
  l.href = window.location.href, t.active = 0, t.ajaxJSONP = function (i, r) {
    ...
    var s, u, o = t.extend({}, e || {}), a = t.Deferred && t.Deferred();
    for (i in t.ajaxSettings)void 0 === o[i] && (o[i] = t.ajaxSettings[i]);
    d(o), o.crossDomain || (s = n.createElement("a"), s.href = o.url, s.href = s.href, o.crossDomain = l.protocol + "//" + l.host != s.protocol + "//" + s.host), o.url || (o.url = window.location.toString()), (u = o.url.indexOf("#")) > -1 && (o.url = o.url.slice(0, u)), T(o);
    var f = o.dataType, h = /\?.+=\?/.test(o.url);
    if (h && (f = "jsonp"), o.cache !== !1 && (e && e.cache === !0 || "script" != f && "jsonp" != f) || (o.url = E(o.url, "_=" + Date.now())), "jsonp" == f)return h || (o.url = E(o.url, o.jsonp ? o.jsonp + "=?" : o.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(o, a);
    var O, p = o.accepts[f], m = {}, b = function (t, e) {
      m[t.toLowerCase()] = [t, e]
    }, S = /^([\w-]+:)\/\//.test(o.url) ? RegExp.$1 : window.location.protocol, j = o.xhr(), C = j.setRequestHeader;
    if (a && a.promise(j), o.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", p || "*/*"), (p = o.mimeType || p) && (p.indexOf(",") > -1 && (p = p.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(p)), (o.contentType || o.contentType !== !1 && o.data && "GET" != o.type.toUpperCase()) && b("Content-Type", o.contentType || "application/x-www-form-urlencoded"), o.headers)for (r in o.headers)b(r, o.headers[r]);
    if (j.setRequestHeader = b, j.onreadystatechange = function () {
        if (4 == j.readyState) {
          ...
          if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == S) {
            if (f = f || x(o.mimeType || j.getResponseHeader("content-type")), "arraybuffer" == j.responseType || "blob" == j.responseType)e = j.response; else {
              e = j.responseText;
              try {
    ...
    j.open(o.type, o.url, P, o.username, o.password);
  ...
  var i, s, u, f, c, l, h, p, d, m, n = "", r = {
    Webkit: "webkit",
    Moz: "",
    O: "o"
  }, o = document.createElement("div"), a = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, g = {};
  t.each(r, function (t, r) {
    ...
    var b, x, S, w = {}, E = "", T = this, j = t.fx.transitionEnd, C = !1;
    if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n)w[h] = n, w[p] = i + "s", w[m] = y + "s", w[d] = r || "linear", j = t.fx.animationEnd; else {
      x = [];
      for (b in n)a.test(b) ? E += b + "(" + n[b] + ") " : (w[b] = n[b], x.push(v(b)));
      E && (w[s] = E, x.push(s)), i > 0 && "object" == typeof n && (w[u] = x.join(", "), w[f] = i + "s", w[l] = y + "s", w[c] = r || "linear")
    }
    return S = function (e) {
